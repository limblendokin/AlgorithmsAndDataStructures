...
namespace Week7
{
    ...
    class AVLTree
    {
        ...
        public Node Insert(int key)
        {
            ...
            Node addedNode = null;
            Stack<Node> pathToInsertedNode = new Stack<Node>();
            while (addedNode == null)
            {
                pathToInsertedNode.Push(currentNode);
            ...
            while (!pathToInsertedNode.IsEmpty())
            {
                currentNode = pathToInsertedNode.Pop();
        ...
        public void Delete(int key)
        {
            ...
            Stack<Node> nodes = new Stack<Node>(Count);
            Node currentNode = Root;
